...
export default function CustomTimeLine() {
    ...
    const customizedMarker = (item) => {
        return (
            <span className="flex w-2rem h-2rem align-items-center justify-content-center text-white z-1 shadow-1" style={{ backgroundColor: item.color,borderRadius:"50%", padding:"10px" }}>
